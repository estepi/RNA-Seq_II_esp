...
En primer lugar elegimos el directorio de trabajo y ponemos allı́ los archivos FASTQ que descargamos, por ejemplo de SRA.
...
\center
\includegraphics[scale=0.15]{selector.png}
...
Repetir el ejercicio con el **SRR5264037_2.fastq.gz** y completar el [cuestionario](https://forms.gle/XbFiUAZMkVPWZsMw5)
