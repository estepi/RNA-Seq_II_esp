...
y <- estimateDisp(y, verbose=TRUE, robust = TRUE)
y$common.dispersion # 
sqrt(y$common.dispersion)
#coeficiente de variación biológica
```

The square root of the common dispersion gives the coefficient of variation of biological variation.   Here the common dispersion is found to be XXX, so the coefficient of biological variation is around XX.
