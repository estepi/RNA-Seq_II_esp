---
title: "Análisis de datos de RNA-Seq. Dia 1"
...
Ahora cargaremos la tabla de counts a nivel gen, que está como archivo adjunto **genes.hits.txt**. Especificamos algunas opciones tales como cuales es la colunma que le da nombre a las filas, asi como si los nombres de las columnas. Para saber sobre estas especificaciones puede consultar el help de *read.table*.
