...
_The square root of the common dispersion gives the coefficient of variation of biological variation.   Here the common dispersion is found to be XXX, so the coefficient of biological variation is around XX._
...
* Ahora fiteamos el modelo:....Fit a negative binomial generalized log-linear model to the read counts for each gene. Conduct genewise statistical tests for a given coefficient or coefficient contrast.
...
podemos ir testeando, de a pares:
