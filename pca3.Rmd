...
Con este tipo de datos podemos hacernos diferentes preguntas o contrastes.
Un caso sencillo sería pensar 1 condición como control y comparar las demás contra esta o por ejemplo si hubiera un orden temporal.

En ese caso, por ejemplo tendriamos un caso donde hay un orden temporal de las muestras: NSC-->ENB-->LNB

Para eso, cargamos los datos y estimaremos los parámetros de dispersión teniendo en cuenta todas las condiciones juntas
...
Podemos seleccionar aquellos genes más afectadoss (de acuerdo por ejemplo al FDR) y de ahi graficarlos en forma de heatmap.
...
## Un contraste alternativo: cada condición es independiente 

Ahora la matriz debe ser definida de esta manera:
...
* Repetimos todos los pasos de estimar la dispersion, definir el modelo y testear por genes DE:
